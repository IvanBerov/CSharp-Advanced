    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                string firsElement = matrix[rowIndexFirst,colIndexFirst];
                string secondElement = matrix[rowIndexSecond, colIndexSecond];

                matrix[rowIndexSecond, colIndexSecond] = firsElement;
        ...
        public static bool validateCommand(string command,int rows,int cols)
        {
            string[] commands = command.Split();
        ...
        public static void fillMatrix(string[,] numbers)
        {
        ...
        public static void printMatrix(string[,] numbers)
        {
            for (int row = 0; row < numbers.GetLength(0); row++)
            {
                for (int col = 0; col < numbers.GetLength(1); col++)
